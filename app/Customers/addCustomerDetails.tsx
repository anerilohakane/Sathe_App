    ...
    return (
        <ScrollView>
            <View className='flex-row rounded-md items-center justify-between px-4 py-3' style={{ backgroundColor: "#0CC0DF" }} >
                ...
                <Text className='font-semibold text-white text-3xl'>Customer Details</Text>
                <TouchableOpacity>
            ...
            <View className='flex-row items-center justify-center gap-3'>
                ...
                <Text className='font-medium text-xl'>Add Customer Details</Text>
            </View>

            {/* Spacing */}
            <View className="h-8"></View>
            {[
                { label: 'Customer ID', placeholder: 'Ex. #009710' },
                { label: 'Customer Name', placeholder: 'Ex. Vikram Jadhav' },
                { label: 'GST Number', placeholder: 'Ex. 29GGGGG1314R9Z6' },
                { label: 'Customer Mobile Number', placeholder: 'Ex. 7843729490' },
            ].map((field, index) => (
